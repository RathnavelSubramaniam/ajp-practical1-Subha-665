...
class Square extends Rectangle
{
    ...
    {
        super(p1,new Point(p1.getX() + sideLength,p1.getY()),new 
        Point(p1.getX() + sideLength,p1.getY() + sideLength),new Point
        (p1.getX(),p1.getY() + sideLength));
    }
}
class Practical1
{
    public static void main(String[] args)
    {
        ...
        System.out.println("Area of trepezoid="+trapezoid.calculateArea
        ());
